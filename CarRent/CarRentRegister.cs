    ...
    public partial class CarRentRegister : Form
    {
        ...
        private void RegisterCarBtn_MouseClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                firstCommand.CommandText = "Select * from Cars where Model = '" + carModelTextBox.Text + "'";
                firstCommand.Parameters.AddWithValue("@CarModel", carModelTextBox.Text);
                ...
                thirdCommand.CommandText = "Select * from Customers where Location = '" + cityTextBox.Text + "'";
                thirdCommand.Parameters.AddWithValue("@CostumerID", clientIdTextBox.Text);
